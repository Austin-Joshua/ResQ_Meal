# Food-101 class names in model output order (same as nutrition101.csv)
# From https://github.com/MaharshSuryawala/Food-Image-Recognition
FOOD_101_CLASSES = [
    ...
    "sushi", "tacos", "octopus balls", "tiramisu", "tuna tartare",
    "waffles",
]
